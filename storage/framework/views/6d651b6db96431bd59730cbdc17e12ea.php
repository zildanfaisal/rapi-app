    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="p-4 flex-1 overflow-auto">
            <ul class="space-y-2">
                ...
                <!-- Dashboard -->
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>" title="Dashboard" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10" :class="sidebarCollapsed ? 'justify-center' : ''">
                ...
                <li>
                    <a href="<?php echo e(route('users.index')); ?>" title="User" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10" :class="sidebarCollapsed ? 'justify-center' : ''">
                        <span class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                ...
                <li x-data="{ open: false }" class="relative">
                    ...
                    <ul x-cloak x-show="open" x-transition class="mt-2 space-y-1 ps-10" style="display:none;">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.view')): ?>
                        <li>
                            <a href="<?php echo e(route('roles.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-white/10 text-sm">Roles</a>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permissions.view')): ?>
                        <li>
                            <a href="<?php echo e(route('permissions.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-white/10 text-sm">Permissions</a>
                        </li>
                        <?php endif; ?>
                ...
                <li x-data="{ open: false }" class="relative">
                    ...
                    <ul x-cloak x-show="open" x-transition class="mt-2 space-y-1 ps-10" style="display:none;">
                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('products.view')): ?>    
                        <li>
                            <a href="<?php echo e(route('products.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-white/10 text-sm">Products</a>
                        </li>
                        <?php endif; ?>
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('products.view')): ?> 
                        <li>
                ...
                <!-- Customers -->
                <li>
                    <a href="<?php echo e(route('customers.index')); ?>" title="Customers" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10" :class="sidebarCollapsed ? 'justify-center' : ''">
                        <span class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                ...
                <!-- Logout -->
                <li>
                    <form action="<?php echo e(route('logout')); ?>" method="POST" data-logout-confirm>
                        <?php echo csrf_field(); ?>
...
</aside><?php /**PATH /Users/mymac/ardhi/project/rapi-app/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>