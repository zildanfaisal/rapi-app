...
@section('header')
    <h2 class="text-xl font-semibold text-gray-800">{{ __('Tambah Data Keuangan') }}</h2>
@endsection
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="max-w-3xl">
                ...
                <form method="POST" action="{{ route('finance-records.store') }}" class="space-y-4">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <select name="tipe" class="w-full px-3 py-2 border rounded" required>
                            ...
                            <option value="income" {{ old('tipe') === 'income' ? 'selected' : '' }}>Pemasukan</option>
                            <option value="expense" {{ old('tipe') === 'expense' ? 'selected' : '' }}>Pengeluaran</option>
                        </select>
