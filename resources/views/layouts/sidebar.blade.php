               ...
               <li x-data="{ open: {{ request()->routeIs('products.*') || request()->routeIs('product-batches.*')  ? 'true' : 'false' }} }" class="relative">
                <button @click.prevent="open = !open"
                  ...
                  <ul x-cloak x-show="open" x-transition class="mt-1.5 space-y-1 pl-12" style="display:none;">
                        ...
                        <li>
                            <button 
                                    @click.stop.prevent="$dispatch('open-batch-report')"
...
<aside x-show="mobileOpen"
    ...
    <button 
        type="button" 
        @click.stop.prevent="$dispatch('open-batch-report')"
        class="w-full text-left block px-3 py-2 rounded-lg text-sm transition-all duration-200 text-slate-600 hover:bg-slate-50">
        Laporan Batch Produk
    </button>
</li>
                        @endcan
               ...
               <!-- Master Penjualan -->
                ...
                <li x-data="{ open: false }" class="relative">
                    <button @click.prevent="open = !open"
                        ...
                        <span x-show="!sidebarCollapsed" class="flex-1 text-start font-medium">Master Finance</span>
                        <svg x-show="!sidebarCollapsed"
                            :class="open ? 'rotate-90' : ''"
                            class="h-4 w-4 transform transition-transform text-slate-600"
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <ul x-cloak x-show="open" x-transition class="mt-1.5 space-y-1 pl-12" style="display:none;">
                        ...
                        <li>
                            <a href="#" class="block px-3 py-2 rounded-lg text-sm transition-all duration-200 text-slate-600 hover:bg-slate-50">History Finance</a>
                        </li>
                    </ul>
                </li>
                <!-- Customers -->
    ...
    <div 
        ...
        <form action="{{ route('product-batches.report') }}" method="GET" target="_blank">
            <div class="mb-4">
                ...
                <select name="filter" class="w-full border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5" required>
            ...
            <div class="mb-4">
                ...
                <input type="month" name="start_date" class="w-full border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5">
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-slate-700 mb-1">Sampai Tanggal</label>
                <input type="month" name="end_date" class="w-full border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5">
            </div>

            <div class="flex justify-end gap-3 mt-6">
                <button type="button" @click="showBatchModal = false" class="px-4 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors font-medium">
                    Batal
                </button>

                <button type="reset" class="px-4 py-2 bg-yellow-50 text-yellow-700 border border-yellow-200 rounded-lg hover:bg-yellow-100 transition-colors font-medium">
                    Reset
                </button>

                <button type="submit" @click="showBatchModal = false" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-lg shadow-blue-600/20">
                    Generate PDF
                </button>
            </div>
        </form>
