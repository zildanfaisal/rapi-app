                    ...
                    <table id="dataTables" class="min-w-full border border-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-black-500 uppercase border-r">Email</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-black-500 uppercase border-r">Status</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-black-500 uppercase border-r">Peran</th>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex justify-center gap-3">
                                        ...
                                        @endcan
                                        @can('users.delete')
                                        <form action="{{ route('users.destroy', $user) }}" method="POST" data-confirm-delete>
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div id="mobileCards" class="space-y-3">
                        ...
                        <div class="mobile-card bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div class="px-4 py-3 text-sm space-y-1">
                                ...
                                <div><span class="text-gray-500">Peran:</span> {{ $user->roles->pluck('name')->join(', ') ?: '-' }}</div>
                            </div>
                            ...
                            <div class="px-4 py-3 bg-gray-50 border-t flex gap-2">
                                ...
                                @endcan
                                @can('users.delete')
                                <form action="{{ route('users.destroy', $user) }}" method="POST" class="flex-1" data-confirm-delete>
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
