                    ...
                    <form method="POST" action="{{ route('pembelian.update', $pembelian->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status_pembayaran" id="status_pembayaran"
                                class="mt-1 w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">
                                <option value="unpaid" @selected(old('status_pembayaran', $pembelian->status_pembayaran) == 'unpaid')>Belum Lunas</option>
                                <option value="paid" @selected(old('status_pembayaran', $pembelian->status_pembayaran) == 'paid')>Lunas</option>
                                {{-- <option value="overdue" @selected(old('status_pembayaran', $pembelian->status_pembayaran) == 'overdue')>Terlambat</option> --}}
                                {{-- <option value="cancelled" @selected(old('status_pembayaran', $pembelian->status_pembayaran) == 'cancelled')>Dibatalkan</option> --}}
                            </select>
                        </div>
