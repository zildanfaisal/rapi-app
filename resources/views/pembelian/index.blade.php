                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50 text-center">
                                ...
                                <td class="border px-3 py-2">
                                    ...
                                    @elseif($p->status_pembayaran === 'unpaid')
                                ...
                                <td class="border px-3 py-2">
                                    <div class="flex flex-col space-y-1">
                                        ...
                                        <form action="{{ route('pembelian.destroy', $p) }}" method="POST" data-confirm-delete class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button class="text-red-600 hover:text-red-800 hover:underline text-left">Hapus</button>
                                        </form>
                                        @endcan
                                    </div>
                                </td>
                    ...
                    <div id="mobileCards" class="space-y-3">
                        ...
                        <div class="mobile-card border rounded-lg bg-white shadow">
                            ...
                            <div class="px-4 py-3 bg-gray-50 border-t flex gap-2">
                                ...
                                @endcan
                                @can('pembelian.delete')
                                <form action="{{ route('pembelian.destroy', $p) }}" method="POST" data-confirm-delete class="flex-1">
                                    @csrf
                                    @method('DELETE')
                                    <button class="w-full border border-red-600 text-red-600 rounded py-2">Hapus</button>
                                </form>
                                @endcan
                            </div>
