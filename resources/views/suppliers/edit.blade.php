...
@section('header')
<h2 class="hidden sm:block text-xl font-semibold text-gray-800">{{ __('Edit Supplier') }}</h2>
@endsection
...
<div class="py-2">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="max-w-xl">
                <h3 class="mb-4">{{ __('Edit Supplier') }}</h3>
                ...
                <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $supplier->no_hp) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat" id="alamat" rows="4"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('alamat', $supplier->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
